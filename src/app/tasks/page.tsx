...
const TasksLists: React.FC = ({ }) => {
  ...
  return (
    <div>
      ...
      <h2>{ }</h2>
      <form
        className=" h-[35rem] flex flex-col justify-center items-center "
      ...
      >
        ...
        <button
          type="submit"
          className="w-1/12 bg-slate-200 rounded-md border-slate-500 border-1 hover:bg-slate-300"
        >
          Ajouter
        </button>
      </form>
      ...
      <section
        className="flex h-[35rem] flex-col"
      >
        <ol
          className="w-2/6 mx-auto items-center ">
          {memoLists.map((list) => (
            <li key={list.id}>
              <div
                className="border-2 h-[5rem] flex items-center p-5 my-5">
                <span
                  className="w-full">
                  {list.title}
                </span>
                <span
                  ...
                  <Button
                    title="Voir plus"
                    route={`../task/${list.id}`}
                    className="w-[1.7rem] h-[1.7rem] text-sm bg-blue-100 hover:bg-blue-200 mr-5" >
                    <Plus
                  ...
                  <Button
                    ...
                    title="Supprimer"
                    className=" w-[1.7rem] h-[1.7rem]  text-sm bg-red-200 hover:bg-red-300">
                    <X
                      className="m-auto text-black" />
                  </Button>
                </span>
